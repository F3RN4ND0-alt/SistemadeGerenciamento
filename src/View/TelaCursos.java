...
public class TelaCursos extends JFrame {
	...
	public TelaCursos() {
		...
		JButton btnEngenharia = new JButton("Entrar");
		btnEngenharia.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnEngenharia.setBounds(55, 260, 90, 30);
		panelEngenharia.add(btnEngenharia);
		...
		JButton btnCiencias = new JButton("Entrar");
		btnCiencias.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnCiencias.setBounds(55, 260, 90, 30);
		panelCiencias.add(btnCiencias);
		...
		JButton btnSistemas = new JButton("Entrar");
		btnSistemas.setFont(new Font("Tahoma", Font.PLAIN, 14));
		btnSistemas.setBounds(55, 260, 90, 30);
		panelSistemas.add(btnSistemas);
	}
}
